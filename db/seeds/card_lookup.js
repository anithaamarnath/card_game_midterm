  ...
  return knex('card_lookup').del()
    .then(function () {
      return Promise.all([
        ...
        knex('card_lookup').insert({id: 14, value: 1, suit: 't'}),
        knex('card_lookup').insert({id: 15, value: 2, suit: 't'}),
        knex('card_lookup').insert({id: 16, value: 3, suit: 't'}),
        knex('card_lookup').insert({id: 17, value: 4, suit: 't'}),
        knex('card_lookup').insert({id: 18, value: 5, suit: 't'}),
        knex('card_lookup').insert({id: 19, value: 6, suit: 't'}),
        knex('card_lookup').insert({id: 20, value: 7, suit: 't'}),
        knex('card_lookup').insert({id: 21, value: 8, suit: 't'}),
        knex('card_lookup').insert({id: 22, value: 9, suit: 't'}),
        knex('card_lookup').insert({id: 23, value: 10, suit: 't'}),
        knex('card_lookup').insert({id: 24, value: 11, suit: 't'}),
        knex('card_lookup').insert({id: 25, value: 12, suit: 't'}),
        knex('card_lookup').insert({id: 26, value: 13, suit: 't'}),
